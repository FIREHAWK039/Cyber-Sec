...
![](https://cdn-images.tryhackme.com/user-uploads/5e6bbe59a46ee9407fd65bbe/room-content/5e6bbe59a46ee9407fd65bbe-1728863959663.png)  

  

In addition to what was mentioned in the above table, there are still a few more namespaces under **Anti-Analysis** with corresponding rules. If you want to dig deeper, please check this [link(opens in new tab)](https://github.com/MBCProject/capa-rules-1/tree/master/anti-analysis).

Use this [link(opens in new tab)](https://github.com/MBCProject/capa-rules-1?tab=readme-ov-file#namespace-organization) if you are interested in the other TLN or Top-Level Namespaces, such as collection, compiler, persistence, linking, and impact.